...
export default async function ProjectsPage() {
  ...
  return (
    <main className="px-4 pt-5 pb-8">
      ...
      {activeCount > 3 && (
        <section className="mt-3 rounded-2xl border border-mxp-orange/50 bg-mxp-card p-4 text-sm">
        ...
        {projects.map((p) => (
          <li key={p.id}>
            ...
            >
              ...
              <div className="mt-2 h-1.5 overflow-hidden rounded-full bg-mxp-bg">
                <div
      ...
      <section className="mt-6 rounded-2xl border border-mxp-line bg-mxp-card p-4">
        <p className="text-xs font-semibold uppercase tracking-wide text-mxp-orange">Nouveau projet</p>
        <form action={createProject} className="mt-3 space-y-3">
          <input
            ...
            className="w-full rounded-xl border border-mxp-line px-4 py-2.5 text-sm outline-none focus:border-mxp-orange"
          />
          <input
            type="text"
            name="desiredOutcome"
          ...
          {goals.length > 0 && (
            <label className="block text-xs text-mxp-muted">
              ...
              <select
                name="goalId"
                className="mt-1 w-full rounded-xl border border-mxp-line bg-mxp-card px-3 py-2.5 text-sm outline-none focus:border-mxp-orange"
              >
